CREATE TYPE "public"."charging_scope" AS ENUM('client', 'moeving');--> statement-breakpoint
CREATE TYPE "public"."driver_type" AS ENUM('driver_only', 'driver_plus_helper', 'driver_cum_helper');--> statement-breakpoint
CREATE TYPE "public"."event_kind" AS ENUM('created', 'stage_changed', 'updated', 'note');--> statement-breakpoint
CREATE TYPE "public"."sales_stage" AS ENUM('first_contact', 'solutioning', 'proposal', 'negotiation', 'closed_won', 'closed_lost', 'dormant');--> statement-breakpoint
...
ALTER TABLE "lost_reasons" ADD CONSTRAINT "lost_reasons_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "opportunities" ADD CONSTRAINT "opportunities_city_id_cities_id_fk" FOREIGN KEY ("city_id") REFERENCES "public"."cities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "opportunities" ADD CONSTRAINT "opportunities_vehicle_type_id_vehicle_types_id_fk" FOREIGN KEY ("vehicle_type_id") REFERENCES "public"."vehicle_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "opportunities" ADD CONSTRAINT "opportunities_lost_reason_id_lost_reasons_id_fk" FOREIGN KEY ("lost_reason_id") REFERENCES "public"."lost_reasons"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "opportunity_events" ADD CONSTRAINT "opportunity_events_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stage_probabilities" ADD CONSTRAINT "stage_probabilities_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "users" ADD CONSTRAINT "users_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "vehicle_types" ADD CONSTRAINT "vehicle_types_organization_id_organizations_id_fk" FOREIGN KEY ("organization_id") REFERENCES "public"."organizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
CREATE UNIQUE INDEX "accounts_org_name_idx" ON "accounts" USING btree ("organization_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "cities_org_name_idx" ON "cities" USING btree ("organization_id","name");--> statement-breakpoint
CREATE UNIQUE INDEX "lost_reasons_org_label_idx" ON "lost_reasons" USING btree ("organization_id","label");--> statement-breakpoint
CREATE INDEX "opps_org_stage_idx" ON "opportunities" USING btree ("organization_id","stage");--> statement-breakpoint
CREATE INDEX "opps_org_owner_idx" ON "opportunities" USING btree ("organization_id","owner_user_id");--> statement-breakpoint
CREATE INDEX "opps_org_close_idx" ON "opportunities" USING btree ("organization_id","expected_close_date");--> statement-breakpoint
CREATE INDEX "opps_org_city_close_idx" ON "opportunities" USING btree ("organization_id","city_id","expected_close_date");--> statement-breakpoint
CREATE INDEX "opp_events_opp_idx" ON "opportunity_events" USING btree ("opportunity_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "stage_prob_org_stage_idx" ON "stage_probabilities" USING btree ("organization_id","stage");--> statement-breakpoint
